...
public class gameOverScene extends Scene {
	...
	public static void setScore(int s) {
		scoreLabel.setText("Score: " + s);
		writePlayerInfoToCSV(playerInfo.getPlayerName(), s);
	}
	...
	private static void writePlayerInfoToCSV(String playerName, int score) {
		System.out.println("updating csv file for leaderboards");
		try {
			BufferedWriter bf = new BufferedWriter(new FileWriter(CSV_FILE_PATH,true));
			bf.write(playerName + "," + score);
			bf.newLine();
			bf.flush();
			bf.close();
		} catch (IOException e) {
